...
<spring:url value="/banners" var="urlRoot"></spring:url>
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<c:forEach items="${banners}" var="banner">
					...
					<tr>
						...
						<td><a href="${urlRoot}/edit/${banner.id}" class="btn btn-success btn-sm" role="button"
							title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
							<a href="${urlRoot}/delete/${banner.id}" onclick='return confirm("¿Estas Seguro?")' class="btn btn-danger btn-sm" role="button"
