			...
			<table class="table table-hover table-striped table-bordered">
				...
				<c:forEach items="${peliculas}" var="pelicula">
					<tr>
						...
						<td><a href="${urlRoot}/edit/${pelicula.id}" class="btn btn-success btn-sm" role="button"
							title="Edit"><span class="glyphicon glyphicon-pencil"></span></a>
							<a href="${urlRoot}/eliminar/${pelicula.id}" onclick='return confirm("¿Estas Seguro?")' class="btn btn-danger btn-sm" role="button"
